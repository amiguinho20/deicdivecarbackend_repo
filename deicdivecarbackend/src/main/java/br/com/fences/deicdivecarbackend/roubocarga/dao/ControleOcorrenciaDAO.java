...
@Named
@ApplicationScoped
public class ControleOcorrenciaDAO {
	...
	public void adicionar(ControleOcorrencia controleOcorrencia) {
		...
		try {
			...
			Document documento = controleOcorrenciaConverter.paraDocumento(controleOcorrencia);
	...
	public ControleOcorrencia pesquisar(ControleOcorrencia controleOcorrencia)
	{
		...
		if (documento != null)
		{
			resultado = controleOcorrenciaConverter.paraObjeto(documento, ControleOcorrencia.class);
		}
		return resultado;
	}
	...
	public Set<ControleOcorrencia> pesquisarProcessarReprocessar() {
		...
		try {
			while (cursor.hasNext()) {
				Document documento = cursor.next();
				ControleOcorrencia controleOcorrencia = controleOcorrenciaConverter.paraObjeto(documento, ControleOcorrencia.class);
